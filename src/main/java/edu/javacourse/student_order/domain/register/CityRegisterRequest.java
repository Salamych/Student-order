...
private String apartment;
    ...
    public String toString() {
        return "CityRegisterRequest{" + "surName=" + surName + ", givenName=" + givenName + ", patronymic=" + patronymic + ", dateOfBirth=" + dateOfBirth + ", streetCode=" + streetCode + ", building=" + building + ", extension=" + extension + ", apartment=" + apartment + '}';
    }
